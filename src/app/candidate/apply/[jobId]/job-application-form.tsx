       ...
       <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Resume{" "}<span className='text-red-600'>*</span></FormLabel>
                <FormControl>
                  <Input placeholder="Enter drive link for your resume" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Cover Letter{" "}<span className='text-red-600'>*</span></FormLabel>
                <FormControl>
                  <Textarea 
